  ...
  template: `
    <div class="container">
      <div class="flex justify-between items-center mb-6">
        <div>
          <h1 class="font-bold" style="margin: 0 0 0.5rem 0;">Job Management</h1>
          <p style="margin: 0; color: #64748b;">Create, edit, and manage job postings</p>
        </div>
          ...
          <div class="card-body">
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-2">
                <a [routerLink]="['/admin/jobs', job.id, 'edit']" class="btn btn-secondary">Edit</a>
                <button 
