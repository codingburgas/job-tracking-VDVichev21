        ...
        <div class="col-12">
          <div class="bg-primary text-white p-4 rounded">
            <div class="row align-items-center">
              <div class="col-md-8">
                <h1 class="h2 mb-1">{{ isEditMode ? 'Edit Job Posting' : 'Create New Job Posting' }}</h1>
                <p class="mb-0">{{ isEditMode ? 'Update job details' : 'Fill in the details to post a new job' }}</p>
              </div>
              <div class="col-md-4 text-md-end">
                <a routerLink="/admin/jobs" class="btn btn-light">Back to Jobs</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <form [formGroup]="jobForm" (ngSubmit)="onSubmit()">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input 
                      ...
                      formControlName="title"
                      placeholder="e.g. Senior Software Developer">
                    <div *ngIf="jobForm.get('title')?.invalid && jobForm.get('title')?.touched" class="text-danger small mt-1">
                      Job title is required
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input 
                      ...
                      formControlName="companyName"
                      placeholder="e.g. Tech Solutions Inc.">
                    <div *ngIf="jobForm.get('companyName')?.invalid && jobForm.get('companyName')?.touched" class="text-danger small mt-1">
                      Company name is required
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <textarea 
                    ...
                    rows="8"></textarea>
                  <div *ngIf="jobForm.get('description')?.invalid && jobForm.get('description')?.touched" class="text-danger small mt-1">
                    Job description is required
                  </div>
                </div>
                ...
                <div class="d-flex gap-2">
                  <a routerLink="/admin/jobs" class="btn btn-outline-secondary">Cancel</a>
                  <button 
                    type="submit" 
                    class="btn btn-primary"
                    [disabled]="jobForm.invalid || loading">
