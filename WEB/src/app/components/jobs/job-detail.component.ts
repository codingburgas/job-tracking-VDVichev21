...
@Component({
  ...
  template: `
    <div class="container-fluid">
      ...
      <div *ngIf="!loading && !job" class="row">
        <div class="col-12">
          ...
          <div class="bg-primary text-white p-4 rounded mb-4">
            <div class="row align-items-center">
              <div class="col-md-8">
                ...
                <h3 class="h5 mb-2">{{ job.companyName }}</h3>
                <div class="row small">
                  <div class="col-auto">Published: {{ job.publishedDate | date:'MMM d, y' }}</div>
                  <div class="col-auto">Applications: {{ job.applicationsCount }}</div>
                  <div class="col-auto">Posted by: {{ job.createdByName }}</div>
                </div>
              </div>
              <div class="col-md-4 text-md-end">
                <span class="badge bg-light text-dark fs-6">{{ job.status }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row g-3">
                ...
                <div *ngIf="isUser() && job.status === 'Active'" class="col-auto">
                  <button
                      *ngIf="!hasApplied && !applyLoading"
                      (click)="applyForJob()"
                      class="btn btn-success">
                  ...
                  <div *ngIf="hasApplied" class="alert alert-success mb-0 d-inline-block">
